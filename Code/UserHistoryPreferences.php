	...
	<ul class="list-unstyled video-list-thumbs row">
      	...
      	?>
				...
				foreach ($Q1res as $key => $value) { ?>
					...
					<video id="video" src="test_upload/<?php echo $value['Name']; ?>" type="video/mp4" width="320" height="176" class="img-responsive">
					</video>
...
<ul class="list-unstyled video-list-thumbs row">
			...
			<li class="col-lg-3 col-sm-4 col-xs-6">
				<a href="playvideo.php?id=<?php echo $value['MediaID'];?>">
				<video id="video" src="test_upload/<?php echo $value['URL']; ?>" type="video/mp4" width="320" height="176" class="img-responsive">
				</video>
