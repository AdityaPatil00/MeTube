...
MeTube
	...
	<div class="row">
		...
		<h1><?php echo $nametag; ?></h1>
				<video id="video1" src="test_upload/<?php echo $first ;?>" type="video/mp4" width="700" height="400" controls="controls">
		</video>
		<br><br>
		...
		<ul class="list-unstyled video-list-thumbs row">
			...
			<?php 
			 ...
			 ?>
				...
				<video id="video" src="test_upload/<?php echo $value['Name']; ?>" type="video/mp4" width="360" height="176" class="img-responsive">
			</video>
